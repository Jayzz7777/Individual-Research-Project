...
def encrypt():
    ...
    with open(f"C:/Users/Jay_s/PycharmProjects/IRP/Recorded_Videos/{current_time}_encrypted.mp4","wb",) as encrypted_file:
...
os.remove(f"C:/Users/Jay_s/PycharmProjects/IRP/Recorded_Videos/{current_time}.mp4")